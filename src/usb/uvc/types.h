...
#ifndef CYPERSTEREO_TYPES_H_
#define CYPERSTEREO_TYPES_H_
 ...
 */
struct  IntrinsicsPinhole : public IntrinsicsBase {
  IntrinsicsPinhole() {
 ...
 */
struct  IntrinsicsEquidistant : public IntrinsicsBase {
